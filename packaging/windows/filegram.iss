...
; the zip. Defines are provided by ISCC via /D flags:
...
;   AppArch        x64 | x86
;   SourceExe      path to the already-built filegram.exe
...
#endif
#ifndef SourceExe
  #error SourceExe must be provided via /DSourceExe=path
#endif
#ifndef OutputName
...
SetupIconFile=assets\icon\filegram.ico
#if AppArch == "x64"
